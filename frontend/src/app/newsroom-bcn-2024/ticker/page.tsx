...
export default function TickerSettingsPage() {
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex flex-col font-bangla overflow-hidden"
    ...
    >
      ...
      {/* Header */}
      <header
        className="px-8 py-4 sticky top-0 z-20 flex items-center justify-between"
        style={{
      ...
      >
        <div className="flex items-center gap-4">
          ...
          <h2
            className="text-white font-bold hidden md:block tracking-widest text-sm border-l border-[#D4AF37]/30 pl-4"
        ...
        <div className="flex items-center gap-2 ml-auto">
          <span className="w-1.5 h-1.5 rounded-full inline-block" style={{ background: '#D4AF37' }} />
      ...
      <div className="flex-1 overflow-y-auto z-10 p-8 max-w-6xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          ...
          <div className="md:col-span-3">
            ...
            >
              <div className="absolute -top-20 -right-20 w-64 h-64 bg-[#D4AF37] rounded-full mix-blend-multiply filter blur-[100px] opacity-10 pointer-events-none" />

              <form onSubmit={handleUpdate} className="relative z-10 space-y-6">
                <div>
                  <label
                    className="flex items-center gap-2 text-sm font-bold text-white mb-3 tracking-wide uppercase"
                    style={{ fontFamily: 'monospace' }}
                  >
                  ...
                  <div className="flex justify-between items-center mt-2 flex-wrap gap-1">
                    <span className="text-xs text-gray-400">
                      সর্বোচ্চ ভিজিবিলিটির জন্য ছোট ও আকর্ষণীয় বাক্য ব্যবহার করুন।
                    </span>
          ...
          <div className="md:col-span-2">
            <div
              className="rounded-2xl p-6 h-full flex flex-col shadow-2xl"
              style={{
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center gap-4">
                ...
                <div className="w-full bg-[#0f172a] border border-gray-700 rounded-full h-12 flex items-center overflow-hidden relative shadow-inner">
                  <div
                    className="absolute left-0 z-10 h-full flex items-center px-4 rounded-r-full shadow-[2px_0_10px_rgba(0,0,0,0.5)]"
                  ...
                  <div className="flex-1 overflow-hidden ml-28 relative h-full flex items-center">
