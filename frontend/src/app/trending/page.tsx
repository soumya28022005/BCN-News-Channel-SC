          ...
          {articles.length === 0 ? (
            ...
            <div className="space-y-4">
              {articles.map((article: any, i: number) => (
                <Link key={article.id} href={`/news/${article.slug}`} className="group flex gap-6 bg-[#111118] rounded-lg p-4 border border-[#1E1E2E] hover:border-[#E53E3E]/40 transition-colors article-card">
                  ...
                  <div className="w-32 h-24 shrink-0 bg-[#1E1E2E] rounded overflow-hidden">
                    {article.thumbnail ? (
                  ...
                  <div className="flex-1">
                    ...
                    {article.excerpt && (
                      <p className="text-xs text-[#64748B] line-clamp-2 mb-2">{article.excerpt}</p>
                    )}
